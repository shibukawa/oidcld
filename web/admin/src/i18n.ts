...
const messages = {
  en: {
    ...
    reverseProxy: {
      ...
      examplesPreferred: "prefer examples",
      defaultStatus: "default {status}",
      requiredClaims: "Required claims: {claims}",
      replayAuthorization: "Replay auth: {enabled}",
    },
    accessLogs: {
      ...
      accessTokenMasked: "[access token]",
      accessTokenTitle: "Access token claims",
      accessTokenRawHeader: "Header",
      accessTokenClaimsUnavailable: "JWT claims could not be decoded in the browser.",
      close: "Close",
  ...
  ja: {
    ...
    reverseProxy: {
      ...
      gateway: "Gateway 認可",
      examplesPreferred: "example 優先",
      defaultStatus: "既定 {status}",
      requiredClaims: "必須 claim: {claims}",
      replayAuthorization: "認証 replay: {enabled}",
    },
    accessLogs: {
      ...
      accessTokenMasked: "[access token]",
      accessTokenTitle: "アクセストークンの claims",
      accessTokenRawHeader: "ヘッダー",
      accessTokenClaimsUnavailable: "ブラウザ上で JWT claims をデコードできませんでした。",
      close: "閉じる",
      bodyType: "本文種別: {kind}",
      bodyEmpty: "(空)",
